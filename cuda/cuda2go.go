...
var tm = map[string]string{"float*": "unsafe.Pointer", "float": "float32", "int": "int", "int*": "unsafe.Pointer", "uint8_t*": "unsafe.Pointer", "uint8_t": "byte", "bool": "bool", "bool*": "unsafe.Pointer"}
