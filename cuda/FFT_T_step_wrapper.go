...
type FFT_Step_args_t struct {
	...
	arg_Ny        int
	arg_Nz        int
	arg_angleReal float32
	arg_angleImag float32
	arg_n         int
...
func init() {
	...
	FFT_Step_args.argptr[6] = unsafe.Pointer(&FFT_Step_args.arg_angleReal)
	FFT_Step_args.argptr[7] = unsafe.Pointer(&FFT_Step_args.arg_angleImag)
	FFT_Step_args.argptr[8] = unsafe.Pointer(&FFT_Step_args.arg_n)
}

// Wrapper for FFT_Step CUDA kernel, asynchronous.
func k_FFT_Step_async(dst unsafe.Pointer, src1 unsafe.Pointer, src2 unsafe.Pointer, Nx int, Ny int, Nz int, angleReal float32, angleImag float32, n int, cfg *config) {
	...
	FFT_Step_args.arg_angleReal = angleReal
	FFT_Step_args.arg_angleImag = angleImag
	FFT_Step_args.arg_n = n

	args := FFT_Step_args.argptr[:]
	cu.LaunchKernel(FFT_Step_code, cfg.Grid.X, cfg.Grid.Y, cfg.Grid.Z, cfg.Block.X, cfg.Block.Y, cfg.Block.Z, 0, stream0, args)
...
$L__BB0_9:
	...
	neg.f32 	%f29, %f28;
	fma.rn.f32 	%f30, %f8, %f23, %f29;
	mov.f32 	%f31, 0f32A57060;
	fma.rn.f32 	%f32, %f8, %f31, %f30;
