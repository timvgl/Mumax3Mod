...
)
{
	...
	ld.param.u64 	%rd2, [addcubicanisotropy2_param_0];
	ld.param.u64 	%rd3, [addcubicanisotropy2_param_1];
	ld.param.u64 	%rd4, [addcubicanisotropy2_param_2];
	ld.param.u64 	%rd5, [addcubicanisotropy2_param_3];
	ld.param.u64 	%rd6, [addcubicanisotropy2_param_4];
	ld.param.u64 	%rd7, [addcubicanisotropy2_param_5];
	ld.param.u64 	%rd8, [addcubicanisotropy2_param_6];
	ld.param.f32 	%f174, [addcubicanisotropy2_param_7];
	ld.param.u64 	%rd9, [addcubicanisotropy2_param_8];
	ld.param.f32 	%f176, [addcubicanisotropy2_param_9];
	ld.param.u64 	%rd10, [addcubicanisotropy2_param_10];
	ld.param.f32 	%f177, [addcubicanisotropy2_param_11];
	ld.param.u64 	%rd11, [addcubicanisotropy2_param_12];
	ld.param.f32 	%f178, [addcubicanisotropy2_param_13];
	ld.param.u64 	%rd12, [addcubicanisotropy2_param_14];
	ld.param.f32 	%f179, [addcubicanisotropy2_param_15];
	ld.param.u64 	%rd13, [addcubicanisotropy2_param_16];
	ld.param.f32 	%f180, [addcubicanisotropy2_param_17];
	ld.param.u64 	%rd14, [addcubicanisotropy2_param_18];
	ld.param.f32 	%f181, [addcubicanisotropy2_param_19];
	ld.param.u64 	%rd15, [addcubicanisotropy2_param_20];
	ld.param.f32 	%f183, [addcubicanisotropy2_param_21];
	ld.param.u64 	%rd16, [addcubicanisotropy2_param_22];
	ld.param.f32 	%f184, [addcubicanisotropy2_param_23];
	ld.param.u64 	%rd17, [addcubicanisotropy2_param_24];
...
$L__BB0_27:
	...
	ld.global.f32 	%f168, [%rd56];
	add.f32 	%f169, %f168, %f165;
	st.global.f32 	[%rd56], %f169;
	...
	ld.global.f32 	%f172, [%rd60];
	add.f32 	%f173, %f172, %f167;
	st.global.f32 	[%rd60], %f173;
