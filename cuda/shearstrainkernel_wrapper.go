...
)
{
	...
	ld.param.u64 	%rd10, [ShearStrain_param_0];
	ld.param.u64 	%rd11, [ShearStrain_param_1];
	ld.param.u64 	%rd12, [ShearStrain_param_2];
	ld.param.u64 	%rd14, [ShearStrain_param_3];
	ld.param.u64 	%rd15, [ShearStrain_param_4];
	ld.param.u64 	%rd13, [ShearStrain_param_5];
	ld.param.u32 	%r39, [ShearStrain_param_6];
	ld.param.u32 	%r40, [ShearStrain_param_7];
	ld.param.u32 	%r41, [ShearStrain_param_8];
...
$L__BB0_34:
	...
	ld.global.nc.f32 	%f48, [%rd8];
	ld.global.nc.f32 	%f49, [%rd49];
	sub.f32 	%f50, %f49, %f48;
