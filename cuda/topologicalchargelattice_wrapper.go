...
$L__BB0_7:
	add.s32 	%r76, %r58, -1;
	min.s32 	%r146, %r10, %r76;
	bra.uni 	$L__BB0_8;

$L__BB0_6:
	rem.s32 	%r74, %r10, %r58;
	add.s32 	%r75, %r74, %r58;
	rem.s32 	%r146, %r75, %r58;
...
$L__BB0_12:
	rem.s32 	%r79, %r19, %r58;
	add.s32 	%r80, %r79, %r58;
	rem.s32 	%r148, %r80, %r58;

$L__BB0_14:
	add.s32 	%r81, %r148, %r4;
	mad.lo.s32 	%r82, %r81, %r57, %r1;
	...
	setp.lt.s32 	%p14, %r6, %r57;
	or.pred  	%p1, %p14, %p13;
	not.pred 	%p15, %p1;
	mov.f32 	%f291, 0f00000000;
	@%p15 bra 	$L__BB0_28;

	setp.ge.s32 	%p16, %r10, %r58;
...
$L__BB0_20:
	rem.s32 	%r88, %r6, %r57;
	add.s32 	%r89, %r88, %r57;
	rem.s32 	%r150, %r89, %r57;

$L__BB0_22:
	add.s32 	%r91, %r149, %r4;
	mad.lo.s32 	%r92, %r91, %r57, %r150;
...
$L__BB0_31:
	rem.s32 	%r101, %r10, %r58;
	add.s32 	%r102, %r101, %r58;
	rem.s32 	%r151, %r102, %r58;
...
$L__BB0_34:
	rem.s32 	%r104, %r14, %r57;
	add.s32 	%r105, %r104, %r57;
	rem.s32 	%r152, %r105, %r57;

$L__BB0_36:
	add.s32 	%r106, %r151, %r4;
	mad.lo.s32 	%r107, %r106, %r57, %r152;
...
$L__BB0_45:
	rem.s32 	%r116, %r19, %r58;
	add.s32 	%r117, %r116, %r58;
	rem.s32 	%r153, %r117, %r58;
...
$L__BB0_48:
	rem.s32 	%r118, %r14, %r57;
	add.s32 	%r119, %r118, %r57;
	rem.s32 	%r154, %r119, %r57;

$L__BB0_50:
	add.s32 	%r120, %r153, %r4;
	mad.lo.s32 	%r121, %r120, %r57, %r154;
...
$L__BB0_59:
	rem.s32 	%r130, %r19, %r58;
	add.s32 	%r131, %r130, %r58;
	rem.s32 	%r155, %r131, %r58;
...
$L__BB0_62:
	...
	rem.s32 	%r156, %r133, %r57;

$L__BB0_64:
	mad.lo.s32 	%r135, %r51, %r57, %r156;
...
$L__BB0_67:
	setp.lt.s32 	%p83, %r55, 0;
	selp.b32 	%r139, 1075235812, 1061752795, %p83;
	or.b32  	%r140, %r139, %r56;
	mov.b32 	%f294, %r140;
	bra.uni 	$L__BB0_69;

$L__BB0_66:
	setp.lt.s32 	%p80, %r55, 0;
