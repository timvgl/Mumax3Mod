...
func k_Madd2CompressedArraysKernel_async(outArr unsafe.Pointer, outArrSize C.size_t, arr1 unsafe.Pointer, len1 C.size_t, arr2 unsafe.Pointer, len2 C.size_t, fac1 float32, fac2 float32, d_outSize unsafe.Pointer, cfg *config) {
	...
	cu.LaunchKernel(Madd2CompressedArraysKernel_code, cfg.Grid.X, cfg.Grid.Y, cfg.Grid.Z, cfg.Block.X, cfg.Block.Y, cfg.Block.Z, 0, stream0, args)
