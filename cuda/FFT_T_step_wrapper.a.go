...
func k_FFT_Step_async(dst unsafe.Pointer, src1 unsafe.Pointer, src2 unsafe.Pointer, Nx int, Ny int, Nz int, angleReal float32, angleImag float32, n int, key string, cfg *config) {
...
)
{
	...
	cvt.rni.s32.f32 	%r81, %f8;
	cvt.rn.f32.s32 	%f9, %r81;
...
$L__BB0_4:
	.pragma "nounroll";
	ld.global.nc.u32 	%r43, [%rd33];
	mad.wide.u32 	%rd17, %r43, %r8, %rd34;
	shr.u64 	%rd34, %rd17, 32;
	st.local.u32 	[%rd32], %rd17;
	add.s64 	%rd33, %rd33, 4;
	add.s64 	%rd32, %rd32, 4;
	add.s32 	%r78, %r78, 1;
	setp.ne.s32 	%p8, %r78, 6;
	@%p8 bra 	$L__BB0_4;
	...
	ld.local.u32 	%r79, [%rd19];
	ld.local.u32 	%r80, [%rd19+-4];
	and.b32  	%r15, %r7, 31;
