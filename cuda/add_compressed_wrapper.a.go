...
// CUDA handle for Madd2CompressedArraysKernel kernel
var Madd2CompressedArraysKernel_code cu.Function

// Stores the arguments for Madd2CompressedArraysKernel kernel invocation
type Madd2CompressedArraysKernel_args_t struct {
	arg_outArr     unsafe.Pointer
	arg_outArrSize C.size_t
	arg_arr1       unsafe.Pointer
	arg_len1       C.size_t
	arg_arr2       unsafe.Pointer
	arg_len2       C.size_t
	arg_fac1       float32
	arg_fac2       float32
	arg_d_outSize  unsafe.Pointer
	argptr         [9]unsafe.Pointer
	sync.Mutex
}

// Stores the arguments for Madd2CompressedArraysKernel kernel invocation
var Madd2CompressedArraysKernel_args Madd2CompressedArraysKernel_args_t

func init() {
	// CUDA driver kernel call wants pointers to arguments, set them up once.
	Madd2CompressedArraysKernel_args.argptr[0] = unsafe.Pointer(&Madd2CompressedArraysKernel_args.arg_outArr)
	Madd2CompressedArraysKernel_args.argptr[1] = unsafe.Pointer(&Madd2CompressedArraysKernel_args.arg_outArrSize)
	Madd2CompressedArraysKernel_args.argptr[2] = unsafe.Pointer(&Madd2CompressedArraysKernel_args.arg_arr1)
	Madd2CompressedArraysKernel_args.argptr[3] = unsafe.Pointer(&Madd2CompressedArraysKernel_args.arg_len1)
	Madd2CompressedArraysKernel_args.argptr[4] = unsafe.Pointer(&Madd2CompressedArraysKernel_args.arg_arr2)
	Madd2CompressedArraysKernel_args.argptr[5] = unsafe.Pointer(&Madd2CompressedArraysKernel_args.arg_len2)
	Madd2CompressedArraysKernel_args.argptr[6] = unsafe.Pointer(&Madd2CompressedArraysKernel_args.arg_fac1)
	Madd2CompressedArraysKernel_args.argptr[7] = unsafe.Pointer(&Madd2CompressedArraysKernel_args.arg_fac2)
	Madd2CompressedArraysKernel_args.argptr[8] = unsafe.Pointer(&Madd2CompressedArraysKernel_args.arg_d_outSize)
}

// Wrapper for Madd2CompressedArraysKernel CUDA kernel, asynchronous.
func k_Madd2CompressedArraysKernel_async(outArr unsafe.Pointer, outArrSize C.size_t, arr1 unsafe.Pointer, len1 C.size_t, arr2 unsafe.Pointer, len2 C.size_t, fac1 float32, fac2 float32, d_outSize unsafe.Pointer, key string, cfg *config) {
	if Synchronous { // debug
		SyncFFT_T(key)
		timer.Start("Madd2CompressedArraysKernel")
	}

	Madd2CompressedArraysKernel_args.Lock()
	defer Madd2CompressedArraysKernel_args.Unlock()

	if Madd2CompressedArraysKernel_code == 0 {
		Madd2CompressedArraysKernel_code = fatbinLoad(Madd2CompressedArraysKernel_map, "Madd2CompressedArraysKernel")
	}

	Madd2CompressedArraysKernel_args.arg_outArr = outArr
	Madd2CompressedArraysKernel_args.arg_outArrSize = outArrSize
	Madd2CompressedArraysKernel_args.arg_arr1 = arr1
	Madd2CompressedArraysKernel_args.arg_len1 = len1
	Madd2CompressedArraysKernel_args.arg_arr2 = arr2
	Madd2CompressedArraysKernel_args.arg_len2 = len2
	Madd2CompressedArraysKernel_args.arg_fac1 = fac1
	Madd2CompressedArraysKernel_args.arg_fac2 = fac2
	Madd2CompressedArraysKernel_args.arg_d_outSize = d_outSize

	args := Madd2CompressedArraysKernel_args.argptr[:]
	cu.LaunchKernel(Madd2CompressedArraysKernel_code, cfg.Grid.X, cfg.Grid.Y, cfg.Grid.Z, cfg.Block.X, cfg.Block.Y, cfg.Block.Z, 0, Get_Stream(key), args)

	if Synchronous { // debug
		SyncFFT_T(key)
		timer.Stop("Madd2CompressedArraysKernel")
	}
}

// maps compute capability on PTX code for Madd2CompressedArraysKernel kernel.
var Madd2CompressedArraysKernel_map = map[int]string{0: "",
	50: Madd2CompressedArraysKernel_ptx_50,
	52: Madd2CompressedArraysKernel_ptx_52,
	53: Madd2CompressedArraysKernel_ptx_53,
	60: Madd2CompressedArraysKernel_ptx_60,
	61: Madd2CompressedArraysKernel_ptx_61,
	62: Madd2CompressedArraysKernel_ptx_62,
	70: Madd2CompressedArraysKernel_ptx_70,
	72: Madd2CompressedArraysKernel_ptx_72,
	75: Madd2CompressedArraysKernel_ptx_75,
	80: Madd2CompressedArraysKernel_ptx_80}

// Madd2CompressedArraysKernel PTX code for various compute capabilities.
const (
	Madd2CompressedArraysKernel_ptx_50 = `
.version 8.2
.target sm_50
.address_size 64
...
`
	Madd2CompressedArraysKernel_ptx_52 = `
.version 8.2
.target sm_52
.address_size 64
...
`
	Madd2CompressedArraysKernel_ptx_53 = `
.version 8.2
.target sm_53
.address_size 64
...
`
	Madd2CompressedArraysKernel_ptx_60 = `
.version 8.2
.target sm_60
.address_size 64
...
`
	Madd2CompressedArraysKernel_ptx_61 = `
.version 8.2
.target sm_61
.address_size 64
...
`
	Madd2CompressedArraysKernel_ptx_62 = `
.version 8.2
.target sm_62
.address_size 64
...
`
	Madd2CompressedArraysKernel_ptx_70 = `
.version 8.2
.target sm_70
.address_size 64
...
`
	Madd2CompressedArraysKernel_ptx_72 = `
.version 8.2
.target sm_72
.address_size 64
...
`
	Madd2CompressedArraysKernel_ptx_75 = `
.version 8.2
.target sm_75
.address_size 64
...
`
	Madd2CompressedArraysKernel_ptx_80 = `
.version 8.2
.target sm_80
.address_size 64
