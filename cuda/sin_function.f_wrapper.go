...
// CUDA handle for sinGovaluate kernel
var sinGovaluate_code cu.Function

// Stores the arguments for sinGovaluate kernel invocation
type sinGovaluate_args_t struct {
...
// Stores the arguments for sinGovaluate kernel invocation
var sinGovaluate_args sinGovaluate_args_t

func init() {
	// CUDA driver kernel call wants pointers to arguments, set them up once.
	sinGovaluate_args.argptr[0] = unsafe.Pointer(&sinGovaluate_args.arg_value)
	sinGovaluate_args.argptr[1] = unsafe.Pointer(&sinGovaluate_args.arg_N)
}

// Wrapper for sinGovaluate CUDA kernel, asynchronous.
func k_sinGovaluate_async(value unsafe.Pointer, N int, cfg *config) {
	if Synchronous { // debug
		Sync()
		timer.Start("sinGovaluate")
	}

	sinGovaluate_args.Lock()
	defer sinGovaluate_args.Unlock()

	if sinGovaluate_code == 0 {
		sinGovaluate_code = fatbinLoad(sinGovaluate_map, "sinGovaluate")
	}

	sinGovaluate_args.arg_value = value
	sinGovaluate_args.arg_N = N

	args := sinGovaluate_args.argptr[:]
	cu.LaunchKernel(sinGovaluate_code, cfg.Grid.X, cfg.Grid.Y, cfg.Grid.Z, cfg.Block.X, cfg.Block.Y, cfg.Block.Z, 0, stream0, args)

	if Synchronous { // debug
		Sync()
		timer.Stop("sinGovaluate")
	}
}

// maps compute capability on PTX code for sinGovaluate kernel.
var sinGovaluate_map = map[int]string{0: "",
	50: sinGovaluate_ptx_50,
	52: sinGovaluate_ptx_52,
	53: sinGovaluate_ptx_53,
	60: sinGovaluate_ptx_60,
	61: sinGovaluate_ptx_61,
	62: sinGovaluate_ptx_62,
	70: sinGovaluate_ptx_70,
	72: sinGovaluate_ptx_72,
	75: sinGovaluate_ptx_75,
	80: sinGovaluate_ptx_80}

// sinGovaluate PTX code for various compute capabilities.
const (
	sinGovaluate_ptx_50 = `
.version 8.4
.target sm_50
...
.visible .entry sinGovaluate(
	.param .u64 sinGovaluate_param_0,
	.param .u32 sinGovaluate_param_1
)
{
	...
	ld.param.u64 	%rd9, [sinGovaluate_param_0];
	ld.param.u32 	%r20, [sinGovaluate_param_1];
	add.u64 	%rd1, %SPL, 0;
