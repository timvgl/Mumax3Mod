...
)
{
	...
	cvt.rni.s32.f32 	%r90, %f15;
	cvt.rn.f32.s32 	%f16, %r90;
...
$L__BB0_7:
	...
	selp.b32 	%r90, %r72, %r73, %p6;
	setp.ne.s32 	%p7, %r70, 0;
	xor.b32  	%r74, %r66, -2147483648;
	selp.b32 	%r75, %r74, %r66, %p7;
	selp.b32 	%r76, -1, 0, %p7;
	xor.b32  	%r77, %r69, %r76;
	shl.b32 	%r78, %r89, 2;
	xor.b32  	%r79, %r78, %r76;
	cvt.u64.u32 	%rd26, %r77;
