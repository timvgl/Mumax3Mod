import { h as sanitize_slots, j as rest_props, k as fallback, l as spread_attributes, m as attr, n as slot, o as bind_props, f as pop, q as sanitize_props, p as push, t as getContext, u as escape_html, v as store_get, w as unsubscribe_stores } from "../../chunks/index2.js";
...
function ExclamationCircleSolid($$payload, $$props) {
  ...
  let ariaLabel = fallback($$props["ariaLabel"], "exclamation circle solid");
  if (title.id || desc.id) {
    hasDescription = true;
  } else {
